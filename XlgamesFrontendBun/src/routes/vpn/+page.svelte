...
<article class="border-2 border-quaternary rounded-2xl h-[264px] py-6 flex items-center flex-col text-center">
...
max-ternary:grid-cols-2 max-nine:grid-cols-1">
    {@render VPNCard?.(language.VPN.OneMonth, prices.OneMonth, "/vpn")}
    {@render VPNCard?.(language.VPN.ThreeMonths, prices.ThreeMonths, "/vpn")}
    {@render VPNCard?.(language.VPN.HalfYear, prices.HalfYear, "/vpn")}
    {@render VPNCard?.(language.VPN.Year, prices.Year, "/vpn")}
  </section>
</article>